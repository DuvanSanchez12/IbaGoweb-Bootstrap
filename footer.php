    <footer class="bg-light text-center py-5 mt-5">
        <div class="d-flex tech-icons justify-content-center mb-3">
            ...
            <a href="https://www.coursera.org/user/4d70e04ea0a1ec1e42e9a544bf5568cb" target="_blank" class="mx-2">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linkedin/linkedin-original.svg" width="28" alt="LinkedIn" />
            </a>
            <a href="https://www.instagram.com/camilo_sanchez547" target="_blank" class="mx-2">
            <img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" width="28" alt="Instagram" />
            </a>
            <a href="mailto:ibago@gmail.com" class="mx-2">
            <img src="https://cdn-icons-png.flaticon.com/512/281/281769.png" width="28" alt="Gmail" />
            </a>
        </div>
        <p class="mt-3 mb-0 text-secondary small">
            © 2025 Duvan Sanchez — Todos los derechos reservados.
        </p>
    </footer>
    ...
    <script
      async
      defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDmlj3lEJjshTIK63cp4NmBf5VageqCzak&callback=initMap"
    ></script>
  </body>
</html>
